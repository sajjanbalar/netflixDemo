...
ReactDOM.render(React.createElement(FullPage, null), document.getElementById('main'));

},{"./components/fullPage":3,"react":37,"react-dom":28}],2:[function(require,module,exports){
var React = require('react');
    ...
    if (this.state.images.length) {
      ...
      if (this.state.loaded >= 6) {
        return React.createElement(
          ...
          React.createElement(
            'div',
            { onMouseOut: this.hideArrows, onMouseOver: this.showArrows },
            this.state.showArrows && React.createElement(PageIndicator, { maxPage: this.state.maxPage, page: this.state.page }),
            React.createElement('img', { onClick: this.goLeft, className: leftArrow, src: '../images/leftArrow.png' }),
            React.createElement(
              'div',
              { id: 'carousel', style: { marginLeft: this.state.marginLeft }, className: 'carouselImages', onMouseOut: this.hideArrows, onMouseOver: this.showArrows },
              this.state.images.map((image, i) => {
                if (i <= 6) {
                  lazy = false;
                }
                return React.createElement(LazyImage, { lazy: lazy, key: image.id, className: 'gif', large: image.images.preview_gif.url, small: image.images.fixed_height_still.url });
              })
            ),
            React.createElement('img', { onClick: this.goRight, className: rightArrow, src: '../images/rightArrow.png' })
          )
        );
      } else {
        return React.createElement(
          ...
          React.createElement(
            'div',
            { id: 'carousel', className: 'carouselImages' },
            this.state.images.map((image, i) => {
              return React.createElement('img', { key: image.id, src: 'https://media.giphy.com/media/KxepQjR5y0dDq/giphy.gif', className: 'loading' });
            }),
            this.state.images.map((image, i) => {
              return React.createElement('img', { key: image.id, onLoad: this.loaded, className: 'hidden', src: image.images.fixed_height_still.url });
            })
          )
        );
      }
  ...
  return React.createElement(
    ...
    pages.map(i => {
      if (i == props.page) {
        return React.createElement(
          'span',
          { key: i, className: 'activePageDash pageDash' },
          '-'
        );
      } else {
        return React.createElement(
          'span',
          { key: i, className: 'pageDash' },
          '-'
        );
      }
    })
...
},{"./lazyImage":4,"react":37}],3:[function(require,module,exports){
var React = require('react');
    ...
    if (this.state.loaded.length >= 3) {
      return React.createElement(
        ...
        this.state.activeCats.map((category, i) => {
          return React.createElement(Carousel, { key: i, index: i, loaded: this.loaded, category: category });
        })
      );
    } else {
      return React.createElement(
        'div',
        { className: 'hidden' },
        React.createElement(Carousel, { key: 0, index: 0, loaded: this.loaded, category: this.state.activeCats[0] }),
        React.createElement(Carousel, { key: 1, index: 1, loaded: this.loaded, category: this.state.activeCats[1] }),
        React.createElement(Carousel, { key: 2, index: 2, loaded: this.loaded, category: this.state.activeCats[2] }),
        React.createElement(Carousel, { key: 3, index: 3, loaded: this.loaded, category: this.state.activeCats[3] })
      );
    }
  }
}
...
},{"./carousel":2,"react":37}],4:[function(require,module,exports){
var React = require('react');
  ...
  render() {
    if (this.props.lazy) {
      return React.createElement(
        LazyLoad,
        { height: 120 },
        React.createElement('img', { className: 'gif', src: this.state.url })
      );
    } else {
      return React.createElement('img', { className: 'gif', src: this.state.url });
    }
  }
}
module.exports = LazyImage;

},{"react":37,"react-lazyload":30}],5:[function(require,module,exports){
/**
...
},{"fbjs/lib/ExecutionEnvironment":5,"fbjs/lib/containsNode":8,"fbjs/lib/emptyFunction":9,"fbjs/lib/emptyObject":10,"fbjs/lib/getActiveElement":11,"fbjs/lib/invariant":14,"fbjs/lib/shallowEqual":17,"object-assign":19,"react":37}],28:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./index":30,"react":37}],30:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./decorator":29,"./utils/debounce":31,"./utils/event":32,"./utils/scrollParent":33,"./utils/throttle":34,"_process":20,"prop-types":24,"react":37,"react-dom":28}],31:[function(require,module,exports){
"use strict";
...
},{"_process":20,"fbjs/lib/emptyFunction":9,"fbjs/lib/emptyObject":10,"fbjs/lib/invariant":14,"fbjs/lib/warning":18,"object-assign":19,"prop-types/checkPropTypes":21}],36:[function(require,module,exports){
/** @license React v16.4.0
...
},{"fbjs/lib/emptyFunction":9,"fbjs/lib/emptyObject":10,"fbjs/lib/invariant":14,"object-assign":19}],37:[function(require,module,exports){
(function (process){
'use strict';
...
},{"./cjs/react.development.js":35,"./cjs/react.production.min.js":36,"_process":20}]},{},[1]);
